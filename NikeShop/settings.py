"""
Django settings for NikeShop project.
...
SECRET_KEY = 'django-insecure-r^b1eq8#nh78m@^**5#m%wth=bq#$9trcflp9c#voc=5@b#+!('
...
MIDDLEWARE = [
    ...
    'orders.middleware.CheckBasketMiddleware'
]

ROOT_URLCONF = 'NikeShop.urls'
...
WSGI_APPLICATION = 'NikeShop.wsgi.application'
